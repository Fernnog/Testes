 ...
 * @param {string} [message] - Uma mensagem opcional para sobrescrever o padrão.
 */
export function updateDriveStatusUI(status, message) {
    ...
    switch (status) {
        case 'connected':
            ...
            driveStatusTop.className = 'drive-status-top'; // Reseta classes
        ...
        case 'error':
            ...
            driveStatusTop.className = 'drive-status-top error'; // Adiciona classe de erro
            driveStatusTop.style.backgroundColor = '#dc3545';
            driveStatusTop.style.display = 'inline-block';
            break;
        case 'syncing':
            driveStatusTop.textContent = message || 'Sincronizando...';
            driveStatusTop.className = 'drive-status-top syncing'; // Adiciona classe de sincronia
